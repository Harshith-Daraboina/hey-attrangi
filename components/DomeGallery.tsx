...
export default memo(DomeGallery, (prevProps, nextProps) => {
  // Custom comparison to prevent unnecessary re-renders
  if (prevProps.images !== nextProps.images) return false;
  if (prevProps.fit !== nextProps.fit) return false;
  if (prevProps.minRadius !== nextProps.minRadius) return false;
  if (prevProps.maxRadius !== nextProps.maxRadius) return false;
  if (prevProps.dragSensitivity !== nextProps.dragSensitivity) return false;
  if (prevProps.enlargeTransitionMs !== nextProps.enlargeTransitionMs) return false;
  if (prevProps.grayscale !== nextProps.grayscale) return false;
  if (prevProps.overlayBlurColor !== nextProps.overlayBlurColor) return false;
  return true;
});
