...
// Characters:
let researcher_1_path = '/tasks/gonogo/img/researcher/researcher_1.png';
let researcher_2_path = '/tasks/gonogo/img/researcher/researcher_2.png';
let researcher_3_path = '/tasks/gonogo/img/researcher/researcher_3.png';
let bubble_path = '/tasks/gonogo/img/bubble_line.png';
let researcher_1, researcher_2,researcher_3;
let researcher_width = window_availw/4;
let researcher_height = researcher_width;
let bubble_img;

let fname_success = '/tasks/gonogo/img/icons/success.png';
let fname_bkg = '/tasks/gonogo/img/bkg_finger1.png';
