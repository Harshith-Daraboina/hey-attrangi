...
// Characters:
let researcher_1_path = '/tasks/enumeration/img/researcher/researcher_1.png';
let researcher_2_path = '/tasks/enumeration/img/researcher/researcher_2.png';
let researcher_3_path = '/tasks/enumeration/img/researcher/researcher_3.png';
let bubble_path = '/tasks/enumeration/img/bubble_line.png';
let researcher_1, researcher_2,researcher_3;
let researcher_width = window_availw/4;
let researcher_height = researcher_width;
let bubble_img;

let fname_bkg = '/tasks/enumeration/img/bkg_largewindow.png';
let fname_noise = '/tasks/enumeration/img/noise.png';
