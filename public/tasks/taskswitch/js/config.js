...
let window_availw = (document.getElementById('task-container') ? document.getElementById('task-container').clientWidth : window.innerWidth);
let window_availh = (document.getElementById('task-container') ? document.getElementById('task-container').clientHeight : window.innerHeight);
...
// Characters:
let researcher_1_path = '/tasks/taskswitch/img/researcher/researcher_1.png';
let researcher_2_path = '/tasks/taskswitch/img/researcher/researcher_2.png';
let researcher_3_path = '/tasks/taskswitch/img/researcher/researcher_3.png';
let bubble_path = '/tasks/taskswitch/img/bubble_line.png';
let researcher_1, researcher_2,researcher_3;
let researcher_width = window_availw/4;
let researcher_height = researcher_width;
let bubble_img;

let fname_noise = '/tasks/taskswitch/img/noise.png';
let fname_bkg = '/tasks/taskswitch/img/bkg_finger2.png';
...
let fname_task1 = '/tasks/taskswitch/img/task1.png';
let fname_task2 = '/tasks/taskswitch/img/task2.png';
let fname_instruct1 = '/tasks/taskswitch/img/instruction1.png';
let fname_instruct2 = '/tasks/taskswitch/img/instruction2.png';
