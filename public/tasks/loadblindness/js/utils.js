...
function pageLoad() {
  ...
  {
    // 解像度
    this.width = (document.getElementById('task-container') ? document.getElementById('task-container').clientWidth : window.innerWidth);
    this.height = (document.getElementById('task-container') ? document.getElementById('task-container').clientHeight : window.innerHeight);

    //有効画面サイズ
    this.availWidth = (document.getElementById('task-container') ? document.getElementById('task-container').clientWidth : window.innerWidth);
    this.availHeight = (document.getElementById('task-container') ? document.getElementById('task-container').clientHeight : window.innerHeight);
...
///////////////////////////////////
if (typeof PositionManager === 'undefined') { window.PositionManager = class PositionManager{
