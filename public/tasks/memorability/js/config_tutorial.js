...
let fname_target_tutorial = '/tasks/memorability/img/list_img_target_tutorial.csv';
let fname_filler_tutorial = '/tasks/memorability/img/list_img_filler_tutorial.csv';
