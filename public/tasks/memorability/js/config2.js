...
// Characters:
let researcher_1_path = '/tasks/memorability/img/researcher/researcher_1.png';
let researcher_2_path = '/tasks/memorability/img/researcher/researcher_2.png';
let researcher_3_path = '/tasks/memorability/img/researcher/researcher_3.png';
let bubble_path = '/tasks/memorability/img/bubble_line.png';
let researcher_1, researcher_2,researcher_3;
let researcher_width = window_availw/4;
let researcher_height = researcher_width;
let bubble_img;

let fname_bkg = '/tasks/memorability/img/bkg_finger1.png';
...
let fname_target = '/tasks/memorability/img/list_img_target2.csv';
let fname_filler = '/tasks/memorability/img/list_img_filler2.csv';
